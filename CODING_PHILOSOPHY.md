...
- **Plain prose:** Do not use em dashes. Use a comma, colon, period or hyphen with spaces (` - `) instead. Do not use the Oxford / serial comma unless omitting it would be ambiguous.
