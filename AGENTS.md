...
Public site: GitHub Pages at [eval-driven-development.dev](https://eval-driven-development.dev) (Vite app in `web/`, Markdown in `docs/`; custom-domain DNS in [edge-dns](https://github.com/mzworthington/edge-dns)).
