...
| Subagent vs skill | [docs/subagents.md](./docs/subagents.md) (`skills/subagents.yaml`, [SOPs/subagent-launch.md](./SOPs/subagent-launch.md); `KIT_SKILLS_ONLY` loads SKILL.md in the parent) |
