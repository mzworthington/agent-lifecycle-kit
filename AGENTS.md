...
| Procedures | [SOPs/](./SOPs/), [tasks/](./tasks/) | Repeatable operational checklists (incl. [behavior catalog & XFN](./SOPs/behavior-catalog-and-xfn.md), [complexity hotspots](./SOPs/complexity-hotspots.md), [conventional commits & PR titles](./SOPs/conventional-commits.md), [open / update PR](./SOPs/open-pull-request.md)) |
...
Before marking a phase **COMPLETE**, run [agent-pre-commit](./skills/agent-pre-commit/SKILL.md) when the repo has a pre-commit hook. Commit subjects and PR titles must follow [SOPs/conventional-commits.md](./SOPs/conventional-commits.md). Opening or updating a PR follows [SOPs/open-pull-request.md](./SOPs/open-pull-request.md).
...
- [SOPs/open-pull-request.md](./SOPs/open-pull-request.md) - PR open/update gate (title + React template-candidate notify)
