...
6. **Measure** — [agent-telemetry](../skills/agent-telemetry/SKILL.md): the leading indicator, not generic logs.
7. **Close** — After the timebox: confirmed → default on + prune flag; killed → flag off + prune slice ([agent-prune](../skills/agent-prune/SKILL.md)). Next story records the learning.
