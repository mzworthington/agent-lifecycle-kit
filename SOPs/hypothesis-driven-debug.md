...
State merge/PR status in the user-facing summary without waiting to be asked. Opening or updating a PR follows [open-pull-request.md](./open-pull-request.md) (conventional title + React template-candidate notify when applicable).
