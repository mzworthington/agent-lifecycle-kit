...
- `~/.agents/SOPs/open-pull-request.md` - PR open/update checklist (conventional title + React template-candidate notify)
...
- `~/.agents/skills/agent-pre-commit/SKILL.md` - hook checks, conventional commit/PR title gate, open-PR SOP
