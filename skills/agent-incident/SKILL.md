...
2. **Signals** - Pull Sentry issues, recent deploys, Slack threads, runbooks (MCPs when configured). For RUM / beacon / `insights.*` Worker failures, route to [agent-cloudflare-ops](../agent-cloudflare-ops/SKILL.md). For PostHog ingest / flags, route to [agent-posthog](../agent-posthog/SKILL.md).
