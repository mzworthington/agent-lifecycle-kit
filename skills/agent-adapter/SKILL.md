...
description: >-
  ...
  affects the behavior catalog beyond the TDD plan. Use when connecting domain
  ports to frameworks, ORMs, external services, or after TDD has defined driven
  port interfaces.
kind: role
phase: impl
triggers:
...
- Test-case impact map from `handover_tdd.md` (keep / extend / rewrite / retire / add).
