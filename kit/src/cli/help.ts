...
Commands:
  ...
  eval                 Run skill-trigger evals, or EDD subcommands (run|watch|report|ci|shadow|dataset|compare)
  ...
  agents status        Print launch vs skills-only, miss-rate compare, and the expand-kill line
